...
This repository does not include datasets. Create your own category under data/ as follows:

```
data/
  <your_category>/
    1.images/               # raw images
    2.support-set/          # few-shot support images per class
    3.box/                  # detection boxes (optional)
    4.mask/                 # segmentation masks (optional)
    5.dataset/              # prepared dataset
    6.preprocessed/         # autodistill outputs (baseline)
    7.results/              # FSL results and analysis outputs
    8.refine-dataset/       # refined dataset (optional)
```

Notes
- Large datasets should not be committed to Git.
- See README.md for setup and how to reproduce FSL experiments.
